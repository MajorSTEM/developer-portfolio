...
"\npaid to an individual sales agent.");//output to view
...
final double salesCommission = 4.0;//declaring a constant for the rate of a commissions of a house.
final double agentPrice = .6;//declaring a constant for the rate for agent's price.
