...
//we imported java packages below
import java.awt.*;
...
public class PizzaOrder extends JFrame implements ItemListener,ActionListener
{
	...
	public PizzaOrder()
	{
		...
		//we are creating a button to process the selection
	...
	//we are declaring a method for displaying the bill for pizza
	private void displayBill()
	{
		//we set the editability for billing
	...
	public void itemStateChanged(ItemEvent e)
	{
		...
		if(e.getSource()==smallRb)
		{
			...
			//this is checking the condition for all the crust sizes selected by the user in if statements
	...
	//we are declaring the method actionperformed here
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					//we used displaybill method for performing bill 
					displayBill();
				}
			}
